 ...
 * /book/schedule, or /book/details for the one service with no calendar step,
 * with this param, skipping the /book picker entirely — but <BookingProvider> only mounts under /book/*, so a
