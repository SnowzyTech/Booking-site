  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-[1180px] px-6 pb-[140px] pt-[100px] text-center sm:pb-[220px] sm:pt-[120px] lg:pb-[380px] lg:pt-[150px]">
        <h1 className="mx-auto max-w-[1000px] animate-in text-[45px] font-bold leading-[1.15] tracking-[-0.02em] text-[#1d1620] duration-700 ease-quart fade-in-0 fill-mode-both slide-in-from-bottom-3 sm:text-[44px] md:text-[52px] lg:text-[60px] lg:leading-[1.1] lg:tracking-[-0.03em]">
        ...
        <p className="mx-auto mt-6 max-w-[720px] animate-in text-[16px] font-medium leading-[1.6] text-[#2e2e2e] delay-100 duration-700 ease-quart fade-in-0 fill-mode-both slide-in-from-bottom-3">
